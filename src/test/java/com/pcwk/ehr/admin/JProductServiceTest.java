...
public class JProductServiceTest {
	...
	public void setUp() throws Exception {
		products = Arrays.asList(
					new ProductVO(1, "안동에서 올라온 전통찜닭(2인용)", 16900, 10, 5, 1, "생산지_01", 0, "20221231", "상품설명_01", 0, 2000, 5, "", ""),
					new ProductVO(2, "KF365 노르웨이 생연어회 200g(냉장)", 13900, 20, 2, 1, "노르웨이", 200, "20221211", "팔딱팔딱 싱싱한 노르웨이 연어!", 0, 0, 0, "", ""),
					new ProductVO(3, "탑마루 꿀 밤고구마 1.5kg", 6900, 35, 1, 1, "홍성", 1500, "20221225", "꿀꿀! 꿀 밤고구마!", 0, 0, 0, "", ""),
					new ProductVO(4, "유기농 공주 햇 옥광밤 800g", 14900, 20, 1, 1, "공주", 800, "20230122", "유기농! 맛밤!", 0, 0, 0, "", "")

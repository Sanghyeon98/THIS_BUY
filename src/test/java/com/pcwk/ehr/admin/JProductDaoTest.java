...
public class JProductDaoTest {
	...
	public void setUp() throws Exception {
		prodVO1 = new ProductVO(1, "라라스윗 초코", 2000, 100, 1, 1, "생산지_01", 0, "20221231", "상품설명_01", 0, 2000, 5, "", "");
		prodVO2 = new ProductVO(2, "라라스윗 바닐라", 2000, 100, 1, 1, "생산지_02", 0, "20221231", "상품설명_02", 0, 2000, 5, "", "");
		prodVO3 = new ProductVO(3, "라라스윗 민트초코", 2500, 100, 1, 1, "생산지_03", 0, "20230131", "상품설명_03", 0, 2000, 5, "", "");

...
public class ProductImgVO extends DTO {
	...
	private String viewPath;	// 이미지 저장 경로(img태그에 사용할)
	
	public ProductImgVO() {}
	
	public ProductImgVO(String name, int price, int quantity, int categoryNo, int imageNo, String production, int weight,
	...
	public ProductImgVO(int itemNo, String name, int price, int quantity, int categoryNo, int imageNo, String production,
	...
	public ProductImgVO(int itemNo, String name, int price, int quantity, int categoryNo, int imageNo,
			String production, int weight, String expired, String detail, int discount, int finalPrice, int sales,
			String regDt, String modDt, String saveName, String viewPath) {
		super();
		this.itemNo = itemNo;
		this.name = name;
		this.price = price;
	...
	public String toString() {
		return "ProductImgVO [itemNo=" + itemNo + ", name=" + name + ", price=" + price + ", quantity=" + quantity
				...
				+ finalPrice + ", sales=" + sales + ", regDt=" + regDt + ", modDt=" + modDt + ", saveName=" + saveName
				+ ", viewPath=" + viewPath + ", toString()=" + super.toString() + "]";
	}

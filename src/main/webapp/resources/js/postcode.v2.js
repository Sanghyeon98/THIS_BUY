(function() {
        ...
        a.frame = function() {
            ...
            function b() {
                ...
                return f.userAgent.os.ios && f.isIOSWebview(f.userAgent.ua_string) && (b = {
                    ...
                    overflow: "hidden",
                    "min-width": "300px"
                }), a.setAttribute("frameborder", "0"), a.setAttribute("title", "우편번호서비스 레이어 프레임"), a.style.cssText = f.getStringByOptions(b, ":", ";"), a
            }

            function e(c, d) {
                if (null === p) return alert("POPUP URL을 셋팅해 주세요.");
                var e = a(c),
                    g = b();
            ...
            function k(a, b, c, d) {
                ...
                e.document.write(s(c)), h.setFrameStyle(e.document.getElementsByTagName("html")[0], e.document.getElementsByTagName("body")[0]), e.document.close(), j.setReady(e, function(f, i) {
                    if ("reload" === f) {
            ...
            function m(a, b) {
                var c = a.window;
                c.document.write(s(b)), h.setFrameStyle(c.document.getElementsByTagName("html")[0], c.document.getElementsByTagName("body")[0]), c.document.close();
                try {
    ...
    ! function(a, b, c, d, e) {
        ...
        function l(a) {
            ...
            if (c.width = d.value, c.isFlexibleWidth = d.isFlexible, c.height = e.value, c.isFlexibleHeight = e.isFlexible, c.onComplete && "function" == typeof c.onComplete && c.onComplete !== p.EMPTY_FUNCTION ? c.onComplete = c.onComplete : c.oncomplete && "function" == typeof c.oncomplete && c.oncomplete !== p.EMPTY_FUNCTION ? c.onComplete = c.oncomplete : (c.onComplete = p.EMPTY_FUNCTION, c.oncomplete = p.EMPTY_FUNCTION, c.isViewerMode = !0), c.onResize && "function" == typeof c.onResize && c.onResize !== p.EMPTY_FUNCTION ? c.onResize = c.onResize : c.onresize && "function" == typeof c.onresize && c.onresize !== p.EMPTY_FUNCTION ? c.onResize = c.onresize : (c.onResize = p.EMPTY_FUNCTION, c.onresize = p.EMPTY_FUNCTION), c.onClose && "function" == typeof c.onClose && c.onClose !== p.EMPTY_FUNCTION ? c.onClose = c.onClose : c.onclose && "function" == typeof c.onclose && c.onclose !== p.EMPTY_FUNCTION ? c.onClose = c.onclose : (c.onClose = p.EMPTY_FUNCTION, c.onclose = p.EMPTY_FUNCTION), c.onSearch && "function" == typeof c.onSearch && c.onSearch !== p.EMPTY_FUNCTION ? c.onSearch = c.onSearch : c.onsearch && "function" == typeof c.onsearch && c.onsearch !== p.EMPTY_FUNCTION ? c.onSearch = c.onsearch : (c.onSearch = p.EMPTY_FUNCTION, c.onsearch = p.EMPTY_FUNCTION), "boolean" != typeof c.autoMappingJibun && (c.autoMappingJibun = !0), "boolean" != typeof c.autoMappingRoad && (c.autoMappingRoad = !0), "boolean" != typeof c.autoMapping && (c.autoMapping = !0), "boolean" == typeof a.autoMapping && (c.autoMappingJibun = c.autoMappingRoad = c.autoMapping), "boolean" != typeof c.animation && (c.animation = !1), "boolean" != typeof c.shorthand && (c.shorthand = !0), "boolean" != typeof c.focusInput && (c.focusInput = !0), "boolean" != typeof c.focusContent && (c.focusContent = !0), "boolean" != typeof c.hideMapBtn && (c.hideMapBtn = !1), "boolean" != typeof c.hideEngBtn && (c.hideEngBtn = !1), "boolean" != typeof c.showMoreHName && (c.showMoreHName = !1), "boolean" != typeof c.alwaysShowEngAddr ? c.alwaysShowEngAddr = !1 : c.alwaysShowEngAddr && (c.hideEngBtn = !0), "boolean" != typeof c.submitMode && (c.submitMode = !0), "boolean" != typeof c.useSuggest && (c.useSuggest = !0), "boolean" != typeof c.autoHiddenSuggest && (c.autoHiddenSuggest = !1), isNaN(c.pleaseReadGuide) || "number" != typeof c.pleaseReadGuide ? c.pleaseReadGuide = 0 : (c.pleaseReadGuide = parseInt(c.pleaseReadGuide, 10), c.pleaseReadGuide <= 2 && (c.pleaseReadGuide = 0), c.pleaseReadGuide > 20 && (c.pleaseReadGuide = 20)), isNaN(c.pleaseReadGuideTimer) || "number" != typeof c.pleaseReadGuideTimer ? c.pleaseReadGuideTimer = 1.5 : (c.pleaseReadGuideTimer = parseFloat(c.pleaseReadGuideTimer), c.pleaseReadGuideTimer <= 0 && (c.pleaseReadGuideTimer = 1.5), c.pleaseReadGuideTimer > 60 && (c.pleaseReadGuideTimer = 1.5)), isNaN(c.maxSuggestItems) || "number" != typeof c.maxSuggestItems ? c.maxSuggestItems = 10 : (c.maxSuggestItems = parseInt(c.maxSuggestItems, 10), (c.maxSuggestItems < 1 || c.maxSuggestItems > 10) && (c.maxSuggestItems = 10)), c.windowHeightAvailableForSuggest = 45 * c.maxSuggestItems + 50, c.theme) {
        ...
        if (!m) return void alert("[우편번호 서비스] API 로딩 오류가 발생하였습니다. 확인 바랍니다. 지속적인 오류 발생시 ( https://github.com/daumPostcode/QnA/issues ) 이슈 등록 부탁드립니다.");
        var n = function(a) {
        ...
        s.init(z, x, y), l.prototype = {
            open: function(a) {
                if (!n(!1, "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.")) {
                    ...
                    b = g(b, a), b = h(b, a), b = i(b, a), b = j(b, a), b = k(b, a), b = o.extend(b, {
                        viewType: "popup"
                    }), s.popup.create(b)
                }
            },
